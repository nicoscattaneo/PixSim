#' Norwegian Forest Resource Rasters
#'
...
#' # This example is for illustrative purposes and is not intended to be run
#' # as the PixSim package does not depend on 'terra'
#'
#' # Assuming terra package is installed and loaded with library(terra)
#' # Files <- lapply(Files, function(XX){
#' #   terra::as.data.frame(terra::rast(XX), xy = TRUE)[, 1:3]
#' # })
