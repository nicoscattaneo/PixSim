...
### Pixeltable
A PixelTable is a dataframe-like object that groups data from various maps 
containing forest resource information. It is a highly useful format that 
offers flexibility for performing complex operations on the information 
...
list(Names = Names, Paths = Files)
```

Read and plot the Site Index raster.
```{r Pixeltable2, echo = FALSE}
library(terra)
